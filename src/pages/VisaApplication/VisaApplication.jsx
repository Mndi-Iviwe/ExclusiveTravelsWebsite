...
function VisaApplication() {
    ...
    return (
        <>
            <div className="generated-design-65">
            <div className="rectangle-66">
                <p className="text-67"><span className="text-rgb-15-52-96">Tourist Visa</span></p>
                <p className="text-68"><span className="text-rgb-15-52-96">Application</span></p>
            ...
            <div className="rectangle-70">
                <p className="text-71"><span className="text-rgb-15-52-96">Personal Information</span></p>
            ...
            <p className="text-87"><span className="text-rgb-15-52-96">Travel Information</span></p>
            ...
            <p className="text-99"><span className="text-rgb-15-52-96">Document Upload</span></p>
            ...
            <p className="text-112"><span className="text-rgb-15-52-96">Back to Information</span></p>
            <div className="rectangle-113"></div>
            <p className="text-114"><span className="text-rgb-248-250-252">Submit Application</span></p>
            <p className="text-115"><span className="text-black">Select purpose</span></p>
            </div>
